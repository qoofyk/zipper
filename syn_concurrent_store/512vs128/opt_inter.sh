...
echo "------Optimisation----syn_concurrent_Keep_512vs128_1M8P---------------"
...
my_run_exp2="aprun -n $total_nodes -N 8 -d 4 /N/u/fuyuan/BigRed2/Openfoam/20160518_test/syn_concurrent_store/syn_concurrent_store"
...
# 		echo "*************************************************************************************"
# 		echo "---syn_concurrent_Keep $val KB, cpt_total_blks=${cpt_total_blks[i]},  writer_thousandth = ${writer_thousandth[k]}------"
# 		echo "*************************************************************************************"
...
# 				lfs setstripe --count 4 -o -1 $(printf "/N/dc2/scratch/fuyuan/store/syn_concurrent_store/$directory/cid%03g " $m)
# 			done
# 			$my_run_exp2 $compute_generator_num $compute_writer_num $analysis_reader_num $analysis_writer_num ${block_size[i]} ${cpt_total_blks[i]} ${writer_thousandth[k]} $computer_group_size $num_analysis_nodes $lp ${utime[i]}
...
echo "-------------------------------------------"
block_size=(2)
cpt_total_blks=(32000)
writer_thousandth=(300 350)
# block_size=(2)
# cpt_total_blks=(500)
