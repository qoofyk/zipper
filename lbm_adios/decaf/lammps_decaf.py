...
mod_path = os.environ['BUILD_DIR'] + '/decaf/mod_lammps.so'
...
# Creating the graph
w = nx.DiGraph()
w.add_node("prod", topology=topoProd, func='prod', cmdline=os.environ['BUILD_DIR'] + '/bin/lammps')
w.add_node("con", topology=topoCon, func='con', cmdline=os.environ['BUILD_DIR'] + '/bin/lammps')
w.add_edge("prod", "con", topology=topoDflow, func='dflow', path=mod_path,
           prod_dflow_redist='count', dflow_con_redist='count',cmdline=os.environ['BUILD_DIR'] +'/bin/lammps')

# --- convert the nx graph into a workflow data structure and run the workflow ---
wf.processGraph(w, "lammps")
