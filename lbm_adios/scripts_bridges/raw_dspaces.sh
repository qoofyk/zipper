...
CMD_CONSUMER="$LAUNCHER -hostfile $HOST_DIR/hostfile-app2 -n $PROCS_CONSUMER TAU_TRACE=1 TRACEDIR=${CONSUMER_TRACE_DIR} ${BIN_CONSUMER} ${NSTOP} ${FILESIZE2PRODUCE} ${SCRATCH_DIR} ${PROCS_PRODUCER}"
